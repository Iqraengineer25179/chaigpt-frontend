...
const Footer = () => {
  ...
  <input type='email' placeholder='Enter your email...' value={email}
    ...
    className='w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2 border-amber-400/30 focus:border-amber-400 focus:ring-4 focus:ring-amber-400/20 transition-all duration-300'
    required />
  <button type='submit' className='absolute right-1 top-1 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full flex items-center gap-1.5 shadow-lg hover:shadow-amber-400/30 overflow-hidden transition-all'>
    ...
    <span className='absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-amber-50/30 to-transparent group-hover:translate-x-full transition-transform duration-1000' />
  </button>
</div>
            </form>
          </div>
