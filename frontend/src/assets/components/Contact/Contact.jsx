...
import { FiGlobe, FiMail, FiMapPin, FiPhone, FiMessageSquare, FiArrowRight } from 'react-icons/fi';
import { contactFormFields } from '../../dummydata';
const Contact = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-gray-900 py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 font-[Poppins] relative overflow-hidden'>
      <Toaster position='top-center' reverseOrder={false} toastOptions={{ duration: 4000 }} />
      
      {/* Decorative Elements */}
      <div className='absolute top-20 left-10 w-24 h-24 bg-orange-500/20 rounded-full' />
      <div className='absolute bottom-40 right-20 w-16 h-16 bg-green-500/20 rounded-full' />
      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
          <div className='space-y-6'>
            <div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transition-all duration-300 hover:scale-[1.02] border-l-4 border-amber-500 hover:border-amber-400 group'>
  ...
  <div className='pl-12 relative z-10'>
    <p className='text-amber-100 font-light text-lg'>
      engineeriqra30@gmail.com
       ...
       {/* CONTACT FORM */}
<div className='relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl animate-slide-in-right border border-amber-500/30 hover:border-amber-500/50 transform-border duration-300'>
